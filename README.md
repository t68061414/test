...
<br /><br />
> [!IMPORTANT]
> This SDK is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://staging.speakeasy.com/org/test-company/testworkspace). Delete this section before > publishing to a package manager.
